            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" @change="fileSet" class="custom-file-input"
                         id="exampleInputFile">
  ...
  methods: {
    ...
    checkProps() {
      ...
      if (props) {
        ...
        this.time_read = props.time_read
        this.checkbox = props.is_published
    ...
    async update() {
      ...
      try {
        await api.post('/api/admin/posts/' + this.$route.params.id, formData, config)
            .then(res => {
              res.status === 200 ? router.push('/posts') : ''
            })
      } catch (e) {
